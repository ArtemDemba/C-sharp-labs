...
namespace Lab7
{
    class FractionalNumber : IFormattable, IEquatable<FractionalNumber>, IComparable<FractionalNumber>
    {
        ...
        public static FractionalNumber operator +(FractionalNumber group1, FractionalNumber group2) => new FractionalNumber(
        ...
        public static bool operator >(FractionalNumber group1, FractionalNumber group2) => group1.Numerator * group2.Denomitor > group2.Numerator * group1.Denomitor;

        public static bool operator <(FractionalNumber group1, FractionalNumber group2) => group1.Numerator * group2.Denomitor < group2.Numerator * group1.Denomitor;

        int IComparable<FractionalNumber>.CompareTo(FractionalNumber group) => (Numerator * group.Denomitor).CompareTo(group.Numerator * Denomitor);

        bool IEquatable<FractionalNumber>.Equals(FractionalNumber group)
        {
            if (group == null)
                return false;
            else
        ...
        public string ToString(string format) => ((IFormattable)this).ToString(format, CultureInfo.CurrentCulture);
        ...
        public static explicit operator double(FractionalNumber group) => (double)group.Numerator / group.Denomitor;
    }
}
