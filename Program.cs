...
namespace морской_бой
{
    class Program
    {
        ...
        static void ComputerArangeAndCheckShips(int shipsAmount, ref int dx1, ref int dx2, ref int dx3, ref int dx4,
        ...
        static void Game()
        {
            ...
            //******************************DRAWING FIELDS******************************
            DrawFields(usersField, computersField);
            ComputerArangeAndCheckShips(shipsAmount, ref dx1, ref dx2, ref dx3, ref dx4, ref dx5, ref dy1,
